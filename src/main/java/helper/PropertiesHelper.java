...
public class PropertiesHelper {
    ...
    private static String relPropertiesFilePathDefault = "src/main/resources/configs/config2.properties";

    public static Properties loadAllFiles() {
        LinkedList<String> files = new LinkedList<>();
        // Add tất cả file Properties vào đây theo mẫu
        files.add("src/test/resources/configs/config2.properties");

...
public class ExtentReportManager {
    ...
    public synchronized static ExtentReports createExtentReports() {
        ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalVariable.projectDir + "/report" + "/extentV5/ExtentReport.html");
        ...
        extentReports.setSystemInfo("JDK version", "17");
